<footer class="bg-light text-center text-lg-start ">
  <div class="text-center p-2 mb-0 mt-4 text-light" style="background-color: black;">
    <br>
    <em class="padding-t-3"><strong>Universidad sujeta a inspección y vigilancia por el Ministerio de Educación Nacional.</strong></em>
    <br>
    <br>
    <p style="font-size: 12px;">
    Yopal, Casanare Carrera 19 No. 39-40 - PBX +57 (601) 9157005 Atención al Ciudadano Ext. 100 Ventanilla única de Radicación Ext. 129
