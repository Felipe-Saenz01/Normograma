...
<?php
	...
	if($alertaGu==2){
		...
		Swal.fire({
			title: 'Guardado',
			text: "La clasificacion se ha guardado correctamte",
			icon: 'success',
...
<?php
	...
	if($alertaDel==2){
		...
		Swal.fire({
			title: 'Eliminado',
			text: "Se ha eliminado la clasificacion",
			icon: 'success',
			confirmButtonColor: '#037207',
			confirmButtonText: 'aceptar'
		})	
...
<div class="container-fluid" >
	...
	<h3>Lista Clasificación Normativas<button style="background-color: white;" type="button" class="btn btn-light" 
		...
		title="La tabla almacena todas las diferentes clasificasiones que puede tener una norma."><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
