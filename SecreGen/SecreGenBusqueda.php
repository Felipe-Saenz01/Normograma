<?php
    ...
    *  de ese registro a este mismo archivo por get (SecreGen.php?id='id de la norma') asi que en caso de que este archivo reciba este id
...
<header>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<li><a class="dropdown-item" href="SecreGen.php">Cargar Norma</a></li>
		</ul>
	    </li>
...
<?php
	...
	if($alertaGu==2){
		...
		Swal.fire({
			...
			window.location.href = "SecreGen.php";
		    }
		})
		</script>
	 <?php
...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="card">
			...
			<form class="form-horizontal" method="GET" action="SecreGenBusqueda.php">
...
<table class="table">
	    ...
	    ?>
			<tr>
				...
				<td style="text-align: center;"><a class="btn btn-warning" href="SecreGen.php?id=<?php echo $datos->codigo_gen; ?>" title="Editar Normativa"  ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
		...
		<ul class="pagination justify-content-center">
			...
			<a class="page-link text-success" href="<?php echo "SecreGenBusqueda.php?tipoDoc=".$tipoDoc."&anio_expedicion=".$anio."&numero_norma=".$numero_norma."&pag=".$i; ?>"><?php echo $i ?></a>
		    </li>
		<?php } ?>
		</ul>
	    </nav>
