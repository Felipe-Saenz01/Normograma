...
<?php
	...
	if($alerError==2){
		...
		Swal.fire({
			...
			text: "No es posible eliminar el emisor porque esta siendo usada por una normativa",
			icon: 'warning',
			confirmButtonColor: '#037207',
			confirmButtonText: 'aceptar'
		}).then((result) => {
...
<?php
	...
	if($alertErrorDuplicado==2){
		...
		Swal.fire({
			...
			text: "No es posible guardar este emisor porque ya existe un emisor con ese nombre.",
			icon: 'warning',
			confirmButtonColor: '#037207',
			confirmButtonText: 'aceptar'
		}).then((result) => {
...
<?php
	...
	if($alertErrorDefault==2){
		...
		Swal.fire({
			title: 'Error al Guardar!',
			text: "Ocurrió algún error al intentar guardar/actualizar el emisor.",
			icon: 'warning',
			confirmButtonColor: '#037207',
			confirmButtonText: 'aceptar'
		}).then((result) => {
