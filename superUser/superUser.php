<?php
    ...
    *  de ese registro a este mismo archivo por get (superUser.php?id='id de la norma') asi que en caso de que este archivo reciba este id
...
<table class="table">
	...
	<nav aria-label="Paginación Normativas">
		...
		<a class="page-link text-success" href="superUser.php?pag=<?php echo $i; ?>"><?php echo $i ?></a>
		</li>
	    <?php } ?>
	    </ul>
	</nav>
